...
class AudioConfig:
    ...
    record_seconds: float = 0.8333  # ~1.2 Hz update rate for more responsive localization
    dtype: str = "float32"
...
class DetectionConfig:
    ...
    min_activity_rms: float = 0.0003
    min_activity_peak_to_mean: float = 1.1
